...
const SobreDescricao = () => {
  return (
    <div className={styles.div_sobre_descricao}>
      ...
      <motion.p className={styles.sobre_description} animate={{ x: [ 100, 0 ]}} transition={{ duration: 1.5 }}>Olá! Eu sou o Gilson, estudante de Análise e Desenvolvimento de Sistemas, apaixonado por tecnologia e audio visual. Comecei a estudar a área de tecnologia e logo percebi uma afinidade com desenvolvimento front-end, desde então volto meus estudos para este campo, construindo conhecimento através de cursos e da graduação. Estou em transição de carreira e atualmente procuro estágio, cargo como desenvolvedor júnior ou trainee como Front-End.</motion.p>
