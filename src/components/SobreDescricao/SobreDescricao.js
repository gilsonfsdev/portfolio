...
const SobreDescricao = () => {
  return (
    <div className={styles.div_sobre_descricao}>
      ...
      <a href='https://drive.google.com/uc?export=download&id=1ckRDysMj1ZTB2jwR-vfl9yJi0EfWS9hw' target='_blank' rel='noreferrer' className={styles.sobre_button_cv} animate={{ x: [ 100, 0 ]}} transition={{ duration: 1.5 }}>Download CV</a>
    </div>
  )
}
